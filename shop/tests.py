...
class ProductViewTest(TestCase):
    def test_get_products(self):
        ...
        resource = self.client.get(reverse('shop:products'))
        self.assertEqual(resource.status_code, 200)
        self.assertEqual(len(resource.context['products']), 2)
        self.assertEqual(list(resource.context['products']), [product_1, product_2])
        self.assertContains(resource, 'Product 1')
        self.assertContains(resource, 'Product 2')
